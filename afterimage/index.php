<?php include("header.inc") ?>
			...
			PNG, JPEG and TIFF formats are supported via standard libraries. For convinience, 
			source for libJPEG and libPNG is supplied with libAfterImage. <p>
			Powerfull text rendering capabilities included, providing support for TrueType fonts using <A href="http://www.freetype.org">FreeType library</A>, and
